...
public class EnglishLessonTwoActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_english_lesson_two);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (answer1 == -1 || question2_options.getCheckedRadioButtonId() == -1 || question3_options.getCheckedRadioButtonId() == -1 ||
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(EnglishLessonTwoActivity.this);
                    builder.setMessage("Are you sure you want to submit?")
                            .setPositiveButton("YES", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    ...
                                    Toast toast = new Toast(EnglishLessonTwoActivity.this);
